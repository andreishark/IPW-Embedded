...
fn increase_by_10(config_pwm: &mut ConfigPwm, rgb_1_2_pin: &mut Pwm, rgb_3_pin: &mut Pwm) {
...
fn decrease_by_10(config_pwm: &mut ConfigPwm, rgb_1_2_pin: &mut Pwm, rgb_3_pin: &mut Pwm) {
    if config_pwm.compare_a > config_pwm.top / 10 * 9
        || config_pwm.compare_b > config_pwm.top / 10 * 9
    {
    ...
    loop {
        ...
        match which_button {
            embassy_futures::select::Either::First(_) => {
                increase_by_10(&mut config_pwm, &mut rgb_1_2_pin, &mut rgb_3_pin)
            }
            embassy_futures::select::Either::Second(_) => {
                decrease_by_10(&mut config_pwm, &mut rgb_1_2_pin, &mut rgb_3_pin)
            }
        }
